...
func quit_request():
	#if main.menu_stack.size() > 0 && (main.menu_stack[main.menu_stack.size()-1] is preload("res://majorelle/ui/confirmation_popup.gd")):
	#	return
	#var ConfPopup = main.load_menu("res://majorelle/ui/confirmation_popup.tscn")
